...
- (id)init
{
	if ((self = [super init]))
	{
		...
		bg.position = ccp(512, 384); //Position of the Background
		...
		// Create title label
		CCLabelTTF *title = [CCLabelTTF labelWithString:@" " fontName:@"Trebuchet MS" fontSize:55.0];
        ...
        CCLabelTTF *scoresLabel = [CCLabelTTF labelWithString:scoresString dimensions:CGSizeMake(windowSize.width, windowSize.height / 3) hAlignment:kCCTextAlignmentCenter fontName:@"Trebuchet MS" fontSize:45.0];
		...
		[menu setPosition:ccp(155.7,698.5)]; //74.7, 281.5
        [menu setColor:ccBLACK];
        [backButton setFontName:@"Trebuchet MS"];
        [backButton setFontSize:39.0];
