...
//  Doodle Tunes
//
//  Created by Ranbir Singh on 12/24/12.
//
//
...
- (id)init
{
	if ((self = [super init]))
	{
        CCSprite * bgcredit = [CCSprite spriteWithFile:@"HTP.png"]; //Background for Main
		bgcredit.position = ccp(512, 384); //Position of the Background
		[self addChild:bgcredit]; //Add the Background
        
        [CCMenuItemFont setFontSize:39];
        ...
        backButton.position = ccp(-356.6, 315); // Set Position
